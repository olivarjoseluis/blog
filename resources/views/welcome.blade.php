@extends('bloques-principales.layout')
...
<div class="container">
    ...
    <div class="col s12 m7">
        <h2 class="header">{{$post->titulo}}</h2>
        <div class="card horizontal">
            ...
            <div class="card-stacked">
                ...
                <div class="card-panel teal lighten-2 categoria"> <p class="texto-categoria">{{$post->categoria->nombre}}</p></div>
                    <p>{{$post->fecha_publicado->format('M d')}}</p>
                    <p>{{$post->cuerpo_previo}}</p>
                </div>
                <div class="card-action">
                    
                    @foreach ($post->tags as $tag)
                        <div class="chip">{{$tag->nombre}}</div>
                    @endforeach
                </div>
            </div>
        </div>
